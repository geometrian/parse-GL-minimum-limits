...
struct LimitsBoolean final { //glGetBooleanv(...)
	GLenum param;
	GLboolean vers[2+4+6]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
} limits_boolean[] = {
...
struct LimitsConvParam2 final { //glGetConvolutionParameteriv(...)
	GLenum param;
	GLint vers[2+4+6][2]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
} limits_convparam2[] = {
...
struct LimitsConvParam3 final { //glGetConvolutionParameteriv(...)
	GLenum param;
	GLint vers[2+4+6][3]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
} limits_convparam3[] = {
...
struct LimitsFloat2 final { //glGetFloatv(...)
	GLenum param;
	GLfloat vers[2+4+6][2]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
} limits_float2[] = {
...
struct LimitsFloat final { //glGetFloatv(...)
	GLenum param;
	GLfloat vers[2+4+6]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
} limits_float[] = {
...
struct LimitsFBOAttachParam final { //glGetFramebufferAttachmentParameteriv(...)
	GLenum param;
	GLint vers[2+4+6]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
...
struct LimitsInt64 final { //glGetInteger64v(...)
	GLenum param;
	GLint64 vers[2+4+6]; //GL 2.0,2.1, 3.0,3.1,3.2,3.3, 4.0,4.1,4.2,4.3,4.4,4.5
} limits_int64[] = {
